...
**Source of truth:** Project planning and execution now live on the [{messmass} - From IDEA to LIVE](https://github.com/users/moldovancsaba/projects/8). This file is reference only. Roadmap = Status **Roadmap**; Backlog = not yet broken down; Ready = actionable. Product = **messmass**.
