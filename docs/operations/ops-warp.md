...
`analytics:backfill` (script removed in v12.3.36, messmass#352)
```
...
```bash
seed:variables (removed in v12.3.36)
```
...
3. Run `seed:variables` (script removed in v12.3.36; variables are managed in `/admin/kyc`) to update database
