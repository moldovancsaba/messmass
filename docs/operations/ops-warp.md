...
- `package.json`
- All documentation files (ARCHITECTURE.md, docs/operations/operations-action-plan.md, etc.)
...
`analytics:backfill` (script removed in v12.3.24, messmass#352)
```
...
```bash
seed:variables (removed in v12.3.24)
```
...
3. Run `seed:variables` (script removed in v12.3.24; variables are managed in `/admin/kyc`) to update database
...
- **`docs/operations/operations-learnings.md`** - Historical decisions and lessons learned
- **`docs/operations/operations-roadmap.md`** - Future development plans and milestones
- **`docs/operations/operations-release-notes.md`** - Version history and changes
...
*Version: 12.3.24 | Last Updated: 2026-06-26T10:00:00.000Z (UTC) | Status: Production*
