...
`analytics:backfill` (script removed in v12.3.35, messmass#352)
```
...
```bash
seed:variables (removed in v12.3.35)
```
...
3. Run `seed:variables` (script removed in v12.3.35; variables are managed in `/admin/kyc`) to update database
...
*Version: 12.3.35 | Last Updated: 2026-06-26T10:00:00.000Z (UTC) | Status: Production*
