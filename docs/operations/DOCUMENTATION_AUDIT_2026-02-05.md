...
**Reference:** [DOCUMENTATION_GOVERNANCE.md](../DOCUMENTATION_GOVERNANCE.md) — Merge Rule, Deprecation Strategy, Canonical Policy.
...
|------|-------------------|--------|
| `docs/operations/LEARNINGS.md` | TASKLIST.md (next priorities) | Point to ACTION_PLAN.md. |
| `docs/operations/WARP.md` | TASKLIST.md (active tasks, project status) | Point to ACTION_PLAN.md. |
| `docs/messmass_codex_brain_dump.md` | "TASKLIST.md is archived and exists only as a redirect" | State that execution state lives in ACTION_PLAN.md only; TASKLIST removed per merge rule. |
| `docs/_meta/CANONICAL_MAP.md` | Row for docs/operations/TASKLIST.md | Remove row when file is deleted. |
| `docs/_meta/DOCS_INVENTORY.md` | Row for docs/operations/TASKLIST.md | Remove row when file is deleted. |
...
- **AUDIT_ACTION_PLAN.md** is a different scope (audit-driven actions A-01, A-02…); it references ACTION_PLAN for Admin/ops state. No conflict.
...
| 2 | Update `docs/operations/LEARNINGS.md`: replace TASKLIST.md with ACTION_PLAN.md where it refers to current/next priorities. | Operations | Yes (2026-02-05) |
...
| 4 | Update `docs/messmass_codex_brain_dump.md`: execution state = ACTION_PLAN.md only; TASKLIST removed per merge rule. | Operations | Yes (2026-02-05) |
| 5 | Remove TASKLIST.md from `docs/_meta/CANONICAL_MAP.md` and `docs/_meta/DOCS_INVENTORY.md` (or regenerate after delete). | Operations / tooling | Yes (2026-02-05) |
