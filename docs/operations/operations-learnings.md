...
## [v12.3.34] - 2026-09-07T16:00:00.000Z — A Dead API Fallback Masked Every Protected-Report Error
...
- Added `seed:variables` (script removed in v12.3.34, messmass#352) command
...
```bash
`seed:variables` (script removed in v12.3.34, messmass#352)
```
