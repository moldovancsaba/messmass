...
Status: Archived
Last Updated: 2026-02-06T15:06:00Z
Canonical: No
Owner: Architecture
...
This plan was moved out of the active design docs to avoid maintaining a second backlog. The future work intent is tracked in `docs/operations/operations-roadmap.md` (search for "Table Chart Height Control"). Keep this document only for historical detail/reference.
