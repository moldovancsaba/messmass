...
This is an archived snapshot. Do not treat any embedded checklists as an active backlog.
Track current work in `docs/operations/operations-action-plan.md` (see `OPS-VAR-01`) and future staged enhancements in `docs/operations/operations-roadmap.md`.
