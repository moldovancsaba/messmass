# Legacy Guides Pack (2025)
Status: Archived
Last Updated: 2026-02-05T00:00:00.000Z
Canonical: No
Owner: Documentation

This file consolidates the legacy guides that were previously spread across many single-purpose documents.
Do not use as a source of truth for current behavior. Start at `docs/index.md` and follow canonical docs.

## Contents
- [ADMIN_LAYOUT_SYSTEM.md — Admin Layout & Navigation System (v5.53.0)](#legacy-admin_layout_system)
- [ADMIN_VIEW_QUICK_START.md — 🚀 Unified Admin View System - Quick Start Guide](#legacy-admin_view_quick_start)
- [AI_PRECOMMIT_CHECKLIST.md — AI Pre-Commit Checklist (MANDATORY)](#legacy-ai_precommit_checklist)
- [API_ACCESS_ENHANCEMENT_PLAN.md — API Access Enhancement Plan](#legacy-api_access_enhancement_plan)
- [API_ACCESS_TESTING_GUIDE.md — API Access Testing Guide](#legacy-api_access_testing_guide)
- [API_DOCUMENTATION_SUMMARY.md — API Documentation Summary](#legacy-api_documentation_summary)
- [ASPECT_RATIO_DATA_FLOW_ANALYSIS.md — Aspect Ratio Data Flow Analysis](#legacy-aspect_ratio_data_flow_analysis)
- [BITLY_MANY_TO_MANY_IMPLEMENTATION.md — Bitly Many-to-Many Implementation Summary](#legacy-bitly_many_to_many_implementation)
- [CARD_SYSTEM.md — Card System — ColoredCard Component](#legacy-card_system)
- [CENTRALIZED_MODULE_MANAGEMENT_UPDATE.md — Centralized Module Management - Documentation Update Summary](#legacy-centralized_module_management_update)
- [COMPLETE_MODAL_INVENTORY.md — Complete Modal/Popup Inventory - All Pages](#legacy-complete_modal_inventory)
- [DATABASE_FIELD_NAMING.md — Database Field Naming - Definitive Answer](#legacy-database_field_naming)
- [DISPLAY_VISIBILITY_CONTROLS.md — Chart Display Visibility Controls](#legacy-display_visibility_controls)
- [DYNAMICCHART_MIGRATION_PLAN.md — DynamicChart.tsx Migration Plan](#legacy-dynamicchart_migration_plan)
...
- [MIGRATION_ASSESSMENT.md — 📋 Admin Pages Migration Assessment](#legacy-migration_assessment)
- [MIGRATION_EXAMPLE_CATEGORIES.md — 🎯 Live Migration Example: Categories Page](#legacy-migration_example_categories)
- [MIGRATION_EXAMPLE_USERS.md — 🎯 Migration Example: Users Page](#legacy-migration_example_users)
- [MODAL_AUDIT_AND_REFACTOR.md — Modal/Popup System Audit & Refactor Plan](#legacy-modal_audit_and_refactor)
- [MODAL_SYSTEM.md — Modal System Documentation](#legacy-modal_system)
- [PARTNER_REPORT_ENHANCEMENT_PLAN.md — Partner Report Enhancement Plan](#legacy-partner_report_enhancement_plan)
- [PHASE1_COMPLETE_SUMMARY.md — Phase 1 Completion Summary](#legacy-phase1_complete_summary)
- [PHASE1_EXECUTION_STATUS.md — Phase 1 Execution Status](#legacy-phase1_execution_status)
- [PHASE2_DESIGN_TOKEN_MIGRATION.md — Phase 2: Design Token Migration Plan](#legacy-phase2_design_token_migration)
- [PHASE_4_MIGRATION_COMPLETE.md — ✅ Phase 4 & 5: Admin Page Migrations — In Progress](#legacy-phase_4_migration_complete)
- [PRODUCTION_FIX.md — Production Database Fix Required](#legacy-production_fix)
- [QUICK_ADD_GUIDE.md — ⚡ Quick Add Technical Guide](#legacy-quick_add_guide)
- [QUICK_REFERENCE.md — SINGLE REFERENCE SYSTEM - Quick Reference](#legacy-quick_reference)
- [SINGLE_REFERENCE_SYSTEM.md — SINGLE REFERENCE SYSTEM](#legacy-single_reference_system)
- [TESTING_API_ACCESS.md — Testing Guide: API Access Management System](#legacy-testing_api_access)
- [TESTING_CHECKLIST_CATEGORIES.md — 🧪 Testing Checklist: Categories Migration](#legacy-testing_checklist_categories)
- [TYPOGRAPHY_1.5X_CONSTRAINT.md — Report Typography 1.5x Constraint System](#legacy-typography_1.5x_constraint)
- [TYPOGRAPHY_FINE_TUNING.md — Typography Fine-Tuning: Multi-Tier Constraint System](#legacy-typography_fine_tuning)
- [UNIFIED_ADMIN_FEATURE_LIST.md — Unified Admin System - Complete Feature List](#legacy-unified_admin_feature_list)
...
## ADMIN_LAYOUT_SYSTEM.md — Admin Layout & Navigation System (v5.53.0)
## ADMIN_VIEW_QUICK_START.md — 🚀 Unified Admin View System - Quick Start Guide
## AI_PRECOMMIT_CHECKLIST.md — AI Pre-Commit Checklist (MANDATORY)
## API_ACCESS_ENHANCEMENT_PLAN.md — API Access Enhancement Plan
## API_ACCESS_TESTING_GUIDE.md — API Access Testing Guide
## API_DOCUMENTATION_SUMMARY.md — API Documentation Summary
## ASPECT_RATIO_DATA_FLOW_ANALYSIS.md — Aspect Ratio Data Flow Analysis
## BITLY_MANY_TO_MANY_IMPLEMENTATION.md — Bitly Many-to-Many Implementation Summary
## CARD_SYSTEM.md — Card System — ColoredCard Component
## CENTRALIZED_MODULE_MANAGEMENT_UPDATE.md — Centralized Module Management - Documentation Update Summary
## COMPLETE_MODAL_INVENTORY.md — Complete Modal/Popup Inventory - All Pages
## DATABASE_FIELD_NAMING.md — Database Field Naming - Definitive Answer
## DISPLAY_VISIBILITY_CONTROLS.md — Chart Display Visibility Controls
## DYNAMICCHART_MIGRATION_PLAN.md — DynamicChart.tsx Migration Plan
...
## MIGRATION_ASSESSMENT.md — 📋 Admin Pages Migration Assessment
## MIGRATION_EXAMPLE_CATEGORIES.md — 🎯 Live Migration Example: Categories Page
## MIGRATION_EXAMPLE_USERS.md — 🎯 Migration Example: Users Page
## MODAL_AUDIT_AND_REFACTOR.md — Modal/Popup System Audit & Refactor Plan
## MODAL_SYSTEM.md — Modal System Documentation
## PARTNER_REPORT_ENHANCEMENT_PLAN.md — Partner Report Enhancement Plan
## PHASE1_COMPLETE_SUMMARY.md — Phase 1 Completion Summary
## PHASE1_EXECUTION_STATUS.md — Phase 1 Execution Status
## PHASE2_DESIGN_TOKEN_MIGRATION.md — Phase 2: Design Token Migration Plan
## PHASE_4_MIGRATION_COMPLETE.md — ✅ Phase 4 & 5: Admin Page Migrations — In Progress
## PRODUCTION_FIX.md — Production Database Fix Required
## QUICK_ADD_GUIDE.md — ⚡ Quick Add Technical Guide
## QUICK_REFERENCE.md — SINGLE REFERENCE SYSTEM - Quick Reference
## SINGLE_REFERENCE_SYSTEM.md — SINGLE REFERENCE SYSTEM
## TESTING_API_ACCESS.md — Testing Guide: API Access Management System
## TESTING_CHECKLIST_CATEGORIES.md — 🧪 Testing Checklist: Categories Migration
## TYPOGRAPHY_1.5X_CONSTRAINT.md — Report Typography 1.5x Constraint System
## TYPOGRAPHY_FINE_TUNING.md — Typography Fine-Tuning: Multi-Tier Constraint System
## UNIFIED_ADMIN_FEATURE_LIST.md — Unified Admin System - Complete Feature List
...
- `package.json`
- `VERSION.md`
- All documentation files (ARCHITECTURE.md, docs/operations/TASKLIST.md, etc.)
