...
4. Rely on `docs/_meta/CANONICAL_MAP.md` (regenerated) + `docs/index.md` to resolve historical references without leaving misleading files behind.

## Folder Rules (Where Things Live)
- `docs/index.md`: curated canonical entrypoint (humans start here).
- `docs/messmass_codex_brain_dump.md`: short repo knowledge refresher (keep updated as refactors happen).
...
- `docs/_meta/DOCS_LINK_CHECK.md`: Broken links found: 0
- `docs/_meta/DOCS_TRIAGE.md`: missing metadata = 0; suspicious titles = 0
