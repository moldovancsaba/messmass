...
#### `/api/activation-templates`

| Route | Methods | Auth |
|-------|---------|------|
| `/api/activation-templates` | GET, POST | `getAdminUser, requireAdmin` |
| `/api/activation-templates/[id]` | GET | `requireAdmin` |
| `/api/activation-templates/[id]/participations` | GET, POST | `requireAdmin` |
...
| `/api/data-blocks/duplicate` | POST | `requireAdmin` |
...
| `/api/fan-identities/[id]/loyalty-balance` | GET | `requireAdmin` |
...
| Route | Methods | Auth |
|-------|---------|------|
| `/api/loyalty-missions` | GET, POST | `getAdminUser, requireAdmin` |
| `/api/loyalty-missions/[id]` | GET | `requireAdmin` |
| `/api/loyalty-missions/[id]/completions` | GET, POST | `requireAdmin` |
