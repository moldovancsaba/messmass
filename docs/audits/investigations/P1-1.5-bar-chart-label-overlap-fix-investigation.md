...
3. Preview verification on canonical preview URL
4. Test with page that has multi-line labels (e.g., "Automotive (CPL: €170)")
5. Document evidence (URL, page, expected vs observed, screenshots if needed)
