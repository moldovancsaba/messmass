...
- [x] Canonical association surface: /admin/bitly for link-to-project and link-to-partner management. Evidence: [app/admin/bitly/page.tsx](app/admin/bitly/page.tsx), [ACTION_PLAN.md](ACTION_PLAN.md).
- [x] /admin/partners Bitly selector is a duplicate entry point and should be treated as read-only for association changes. Evidence: [app/admin/partners/page.tsx](app/admin/partners/page.tsx), [ACTION_PLAN.md](ACTION_PLAN.md).
